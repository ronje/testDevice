...
from app.api_1.admin import admin_bp
from app.api_1.auth import auth_bp

from app.extensions import db, login_manager, csrf, socketio, moment,sockets
from app.dataBase.models import Users,Devices, Messages
...
def register_commands(app):
    ...
    def forge(message):
        ...
        from faker import Faker   #专门生成各类假数据的库：Faker
        fake = Faker()
